...
struct tag {
    ...
    auto transform_sender(TagParam, Sender&& sender, Env&&...) noexcept(Noexcept) {
...
auto test_transform_sender(Domain) {
    ...
    static_assert(not requires { Domain::transform_sender(simple_tag{}, non_sender{}); });
    static_assert(requires { Domain::transform_sender(simple_tag{}, simple_sender{}); });
    static_assert(requires { Domain::transform_sender(simple_tag{}, simple_sender{}, env{}); });
    static_assert(not requires { Domain::transform_sender(simple_tag{}, simple_sender{}, env{}, env{}); });
    ...
    using simple_env_lvalue_type = decltype(Domain::transform_sender(simple_tag{}, sender, env{}));
    static_assert(std::same_as<simple_sender&, simple_env_lvalue_type>);
    const simple_sender csender;
    using simple_clvalue_type = decltype(Domain::transform_sender(simple_tag{}, csender));
    static_assert(std::same_as<const simple_sender&, simple_clvalue_type>);
    using simple_env_clvalue_type = decltype(Domain::transform_sender(simple_tag{}, csender, env{}));
    static_assert(std::same_as<const simple_sender&, simple_env_clvalue_type>);

    ASSERT(simple_sender{17} == Domain::transform_sender(simple_tag{}, simple_sender{17}, env{}));
    ASSERT(&sender == &Domain::transform_sender(simple_tag{}, sender, env{}));
    ASSERT(&csender == &Domain::transform_sender(simple_tag{}, csender, env{}));
    ...
    static_assert(requires { tag<true>().transform_sender(simple_tag{}, tagged_sender<true>()); });
    static_assert(requires { tag<true>().transform_sender(simple_tag{}, tagged_sender<true>(), env{}); });
    static_assert(requires { tag<false>().transform_sender(simple_tag{}, tagged_sender<false>()); });
    static_assert(requires { tag<false>().transform_sender(simple_tag{}, tagged_sender<false>(), env{}); });
    static_assert(requires { Domain::transform_sender(simple_tag{}, tagged_sender<true>()); });
    static_assert(requires { Domain::transform_sender(simple_tag{}, tagged_sender<true>(), env{}); });
    static_assert(not requires { Domain::transform_sender(simple_tag{}, tagged_sender<true>(), env{}, env{}); });
    static_assert(requires { Domain::transform_sender(simple_tag{}, tagged_sender<false>()); });
    static_assert(requires { Domain::transform_sender(simple_tag{}, tagged_sender<false>(), env{}); });
    static_assert(not requires { Domain::transform_sender(simple_tag{}, tagged_sender<false>(), env{}, env{}); });
    static_assert(noexcept(Domain::transform_sender(simple_tag{}, tagged_sender<true>())));
    static_assert(noexcept(Domain::transform_sender(simple_tag{}, tagged_sender<true>(), env{})));
    static_assert(not noexcept(Domain::transform_sender(simple_tag{}, tagged_sender<false>())));
    static_assert(not noexcept(Domain::transform_sender(simple_tag{}, tagged_sender<false>(), env{})));
    {
        using type = decltype(Domain::transform_sender(simple_tag{}, tagged_sender<true>()));
        static_assert(std::same_as<simple_sender, type>);
        ASSERT(simple_sender{17} == Domain::transform_sender(simple_tag{}, tagged_sender<true>()));
    }
    {
        using type = decltype(Domain::transform_sender(simple_tag{}, tagged_sender<true>(), env{}));
        static_assert(std::same_as<simple_sender, type>);
        ASSERT(simple_sender{17} == Domain::transform_sender(simple_tag{}, tagged_sender<true>(), env{}));
    }
    {
        using type = decltype(Domain::transform_sender(simple_tag{}, tagged_sender<false>()));
        static_assert(std::same_as<simple_sender, type>);
        ASSERT(simple_sender{17} == Domain::transform_sender(simple_tag{}, tagged_sender<false>()));
    }
    {
        using type = decltype(Domain::transform_sender(simple_tag{}, tagged_sender<false>(), env{}));
        static_assert(std::same_as<simple_sender, type>);
        ASSERT(simple_sender{17} == Domain::transform_sender(simple_tag{}, tagged_sender<false>(), env{}));
    }
